...
describe('Convex Allocation Algorithm', () => {
    ...
    it('should calculate MR weights correctly (Stage 1)', () => {
        ...
        const providerSlots: AvailabilitySlot[] = [
            { id: 's1', quantity: 10, need_type_id: 't1', name: 'S1', members: [] }
        ];
        ...
        const allCommitments: Record<string, Commitment> = {
            'r1': {
                need_slots: [
                    { id: 'n1', quantity: 5, need_type_id: 't1', name: 'Need 1' }
                ],
    ...
    it('should allocate proportionally to need and MR (Fairness)', () => {
        ...
        const providerSlots: AvailabilitySlot[] = [
            { id: 'p1', quantity: 100, need_type_id: 't1', name: 'P1', members: [] }
        ];

        const myRecognition = { 'r1': 1.0, 'r2': 1.0 };
        const allCommitments: Record<string, Commitment> = {
            'r1': {
                need_slots: [{ id: 'n1', quantity: 100, need_type_id: 't1', name: 'N1' }],
                global_recognition_weights: { 'provider': 1.0 },
                timestamp: 1, itcStamp: {}
            },
            'r2': {
                need_slots: [{ id: 'n2', quantity: 100, need_type_id: 't1', name: 'N2' }],
                global_recognition_weights: { 'provider': 1.0 },
                timestamp: 1, itcStamp: {}
            }
        };
    ...
    it('should respect compatibility constraints', () => {
        ...
        const providerSlots: AvailabilitySlot[] = [
            { id: 'p1', quantity: 10, need_type_id: 'TypeA', name: 'P1', members: [] }
        ];

        const myRecognition = { 'r1': 1.0, 'r2': 1.0 };
        const allCommitments: Record<string, Commitment> = {
            'r1': {
                need_slots: [{ id: 'n1', quantity: 10, need_type_id: 'TypeB', name: 'N1' }],
                global_recognition_weights: { 'provider': 1.0 },
                timestamp: 1, itcStamp: {}
            },
            'r2': {
                need_slots: [{ id: 'n2', quantity: 10, need_type_id: 'TypeA', name: 'N2' }],
                global_recognition_weights: { 'provider': 1.0 },
                timestamp: 1, itcStamp: {}
            }
        };
