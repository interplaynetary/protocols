...
const main = l.record<'tid', Main>(
  ...
  $nsid,
  l.object({
    omUnitIdentifier: l.optional(l.string({ format: 'uri' })),
    label: l.string(),
    symbol: l.optional(l.string()),
