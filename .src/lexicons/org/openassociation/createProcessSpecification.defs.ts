...
const $nsid = 'org.openassociation.createProcessSpecification'

export { $nsid }

/** Create or update a processSpecification record. Include `uri` in the body to update an existing record. */
